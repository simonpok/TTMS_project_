...
public:
    ...
    void cabDetails()
    {
        ...
        cout << "-----------ABC Cabs-----------\n" << endl;
        cout << "1. Rent a Standard Cab - Rs.500 for 1 hour" << endl;
        cout << "2. Rent a Luxury Cab - Rs.800 per 1 hour" << endl;
        ...
        cin >> cabChoice;
        cout << "Enter total rent time in hour: ";
        cin >> kilometers;
...
public:
    ...
    void hotels()
    {
    	...
    	heading();
    	Travel o;
        string hotelNo[] = {"Yeti", "Marriot", "Annapurna"};
        for(int a = 0; a < 3; a++)
        {
